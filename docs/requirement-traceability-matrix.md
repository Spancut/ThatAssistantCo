...
| SAFE-010 | Secrets/real client data never enter commits, fixtures, logs, analytics | Security; Part 11 §§14–15 | PARTIALLY COMPLETE | T000 removes local credentials/legacy fixtures and ignores secret files; later telemetry controls absent | source, log, event | T003/T035 | Redaction and analytics allowlist | T003/T035 |
...
| T001-R | Claude Code governance package | Part 11 §18 T001 | PARTIALLY COMPLETE | `AGENTS.md`, journal, approved templates; no root `CLAUDE.md` or architecture package | ticket, ADR | T000 | Root CLAUDE, architecture docs, governance process, safe checks | T001 |
